...
def get_seed_cases() -> Dict[str, CaseDetail]:
    ...
    # Attach blockchain proof data to each custody event
    coc_204_1.blockchain_proof = {
        "contract_address": "0x742d35Cc6634C0532925a3b8D4C9b9f4C3e1A8B2",
        "tx_hash": "0xa1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2",
        "merkle_root": "0x9f8e7d6c5b4a3928170605040302010f0e0d0c0b0a090807060504030201009f",
        "block_height": 52847391,
        "gas_used": 21045,
        "status": "CONFIRMED ON-CHAIN",
        "network": "Polygon POS Mainnet"
    }
    coc_204_2.blockchain_proof = {
        "contract_address": "0x742d35Cc6634C0532925a3b8D4C9b9f4C3e1A8B2",
        "tx_hash": "0xb2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3",
        "merkle_root": "0x8e7d6c5b4a392817060504030201009f8e7d6c5b4a392817060504030201009f8e",
        "block_height": 52847412,
        "gas_used": 21045,
        "status": "CONFIRMED ON-CHAIN",
        "network": "Polygon POS Mainnet"
    }
    coc_204_3.blockchain_proof = {
        "contract_address": "0x742d35Cc6634C0532925a3b8D4C9b9f4C3e1A8B2",
        "tx_hash": "0xc3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4",
        "merkle_root": "0x7d6c5b4a392817060504030201009f8e7d6c5b4a392817060504030201009f8e7d",
        "block_height": 52847435,
        "gas_used": 21045,
        "status": "CONFIRMED ON-CHAIN",
        "network": "Polygon POS Mainnet"
    }
    ...
    coc_205_2 = ChainOfCustodyService.create_event(
        actor="Forensic Parser",
        role="PARSER",
        action="HEADER_RECONSTRUCTION",
        artifact_id="EV-HEADER-205",
        details="Reconstructed 1 flight recorder hop. Origin relay IP 194.26.29.112 flagged on AS44477 bulletproof host.",
        prev_events=[coc_205_1]
    )
    coc_205_3 = ChainOfCustodyService.create_event(
        actor="Sarah Jenkins (Incident Response)",
        role="INVESTIGATOR",
        action="ESCALATE_TO_CRITICAL",
        artifact_id="EV-DECISION-205",
        details="Confirmed Microsoft SSO brand spoofing via 3-hop redirect chain to credential harvesting portal.",
        prev_events=[coc_205_1, coc_205_2]
    )

    # Blockchain proof for CASE-205 custody events
    coc_205_1.blockchain_proof = {
        "contract_address": "0x742d35Cc6634C0532925a3b8D4C9b9f4C3e1A8B2",
        "tx_hash": "0xd4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5",
        "merkle_root": "0x6c5b4a392817060504030201009f8e7d6c5b4a392817060504030201009f8e7d6c",
        "block_height": 52847501,
        "gas_used": 21045,
        "status": "CONFIRMED ON-CHAIN",
        "network": "Polygon POS Mainnet"
    }
    coc_205_2.blockchain_proof = {
        "contract_address": "0x742d35Cc6634C0532925a3b8D4C9b9f4C3e1A8B2",
        "tx_hash": "0xe5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6",
        "merkle_root": "0x5b4a392817060504030201009f8e7d6c5b4a392817060504030201009f8e7d6c5b",
        "block_height": 52847519,
        "gas_used": 21045,
        "status": "CONFIRMED ON-CHAIN",
        "network": "Polygon POS Mainnet"
    }
    coc_205_3.blockchain_proof = {
        "contract_address": "0x742d35Cc6634C0532925a3b8D4C9b9f4C3e1A8B2",
        "tx_hash": "0xf6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7",
        "merkle_root": "0x4a392817060504030201009f8e7d6c5b4a392817060504030201009f8e7d6c5b4a",
        "block_height": 52847548,
        "gas_used": 21045,
        "status": "CONFIRMED ON-CHAIN",
        "network": "Polygon POS Mainnet"
    }
    ...
    case_205 = CaseDetail(
        ...
        chain_of_custody=[coc_205_1, coc_205_2, coc_205_3]
    )
